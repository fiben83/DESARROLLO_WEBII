...
<div id="header">
      <a href="/TiendaWeb/" class="float"><img src="cssimages/logo.jpg" alt="" width="171" height="73" /></a>																																																		<div class="inner_copy"><a href="http://www.greatdirectories.org/">web directories</a><a href="http://www.bestfreetemplates.info/">free CSS templates</a></div>
       ...
       <ul id="menu">
		...
		<li><a href="Editar_User.action"/><img src="cssimages/but9.gif" alt="" width="71" height="29" /></a></li>
        </ul>
	</div>
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    <div id="about">
						...
						<s:textfield label="Usuario" required="true" name="user.nick" cssClass="input"/>
						<s:password label="Password" required="true" name="user.password" cssClass="input"/>
						<s:label for="selectUser" value="Selection User: "/>
						<s:select list="#{'1':'Administrador','2':'cliente'}" id="selectUser" name="selectUser" headerKey="-1" headerValue="Selection option"/>
						<p class="line center pad20"><s:submit value="Loguearse"/>
