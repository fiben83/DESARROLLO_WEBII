	...
	<div id="container">
            <div id="center" class="column"><br />
                <div id="content">
                    ...
                    <p class="line centerred"></p>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Inserte un nuevo disco<a href="ShowForm_Record.action" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque un disco para editarlo o borrarlo<a href="#" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                 <div id="content">
                    <div id="about">
                        <p class="tree"><b>Agregar un nuevo usuario <a href="ShowForm_User.action" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque un usuario registrado<a href="Show_User.action" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Busque una factura de venta<a href="#" class="reg">AQUI</a></b></p>
                    </div>
                </div>
                <div id="content">
                    <div id="about">
                        <p class="tree"><b>Salga de la cuenta (LOGOUT)<a href="Editar_User.action" class="reg">AQUI</a></b></p>
                    </div>
                </div>
            </div>
