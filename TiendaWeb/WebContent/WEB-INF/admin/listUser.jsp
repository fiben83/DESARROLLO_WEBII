...
<style type="text/css">@import url(css/metro/estilos.css);</style>
            ...
            <div id="center" class="column">
                <div id="content">
                    <div id="about">
                         ...
                         <s:form method="post" action="Search_User">
                         	<p class="line"><s:textfield name="user.nick" id="user.nick" label="Nick" labelposition="top"/></p>
							<p class="line"><s:textfield name="user.firstName" id="user.firstName" label="Nombre" labelposition="top" cssClass="input"/></p>
							<p class="line"><s:textfield name="user.lastName" id="user.lastName" label="Apellidos" labelposition="top" cssClass="input"/></p>
                        	...
                        	<p class="liner"><s:submit value="Buscar"/></p>
						</s:form> 
                                                 
                        <div id="users">
                            <table border="0" id="tabla" cellpadding="0" cellspacing="0">
								<tr><td><b>Nick</b></td><td><b>FirstName</b></td><td><b>LastName</b></td><td><b>Email</b></td></tr>
									<s:iterator value="user" status="linea">
