                    ...
                    <div id="about">
 					...
 					<div id="content">
                        ...
                        <table border="1" id="tabla" cellpadding="2" cellspacing="2">
							<tr><td><b>ID</b></td><td><b>Nombre</b></td><td><b>Artista</b></td><td><b>Price</b></td><td><b>Stock</b></td><td colspan="2" align="center"><b>Gesti&oacute;n</b></td></tr>
							<s:iterator value="listaRecords" status="linea">
							<s:if test="#linea.odd"><tr class="linea1"></s:if>
							<s:if test="#linea.even"><tr class="linea2"></s:if>
    							<td><s:property value="idRecord"/></td>
    							<td><s:property value="name"/></td>
    							<td><s:property value="artist"/></td>
    							<td><s:property value="price"/></td>
    							<td><s:property value="stock"/></td>
    							<td align="center"><a href="Editar_Record.action?idRecordActual=${idRecord}"/><img src="imagenes/editarcliente.png" alt="Editar" title="Editar" border="0"/></a></td>
    							<td align="center"><a href="Delete_Record.action?idRecordActual=${idRecord}"/><img src="imagenes/eliminarcliente.png" alt="Eliminar" title="Eliminar" border="0"/></a></td>
  							</tr>
							</s:iterator>
						</table>	
                    	</div>
