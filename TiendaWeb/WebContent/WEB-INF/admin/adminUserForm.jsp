            ...
            <div id="content">
                    <div id="about">
                     ...
                     <s:form method="post" action="Add_User">
                        ...
                        </span> Dia: <select name="birthDay"><%for(int i=1;i<=31;i++){%><option><%=i%></option><%}%></select>&nbsp;&nbsp;Mes: <select name="birthMonth"><%for(int i=1;i<=12;i++) {%><option><%=i%></option><%}%></select>&nbsp;&nbsp;Año: <select name="birthYear"></p>
                  ...
                  <div id="content">
                        ...
                        <table border="1" id="tabla" cellpadding="2" cellspacing="2">
							<tr><td><b>ID</b></td><td><b>Usuario</b></td><td><b>Contraseña</b></td><td><b>Nombre</b></td><td><b>Apellido</b></td><td colspan="2" align="center"><b>Gesti&oacute;n</b></td></tr>
